...
{
    public class EndpointTeam
    {
        [JsonProperty("id")] public string Id { get; set; }

        [JsonProperty("bonus_casa")] public string BonusCasa { get; set; }

        [JsonProperty("bonus_punti")] public string BonusPunti { get; set; }

        [JsonProperty("giornata")] public string Giornata { get; set; }
